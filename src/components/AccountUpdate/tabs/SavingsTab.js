...
class SavingsTab extends Component {
  ...
  handleMultiSelect = (optionValue) => {
    ...
    console.log('🎯 [SavingsTab] FULL props.data =', JSON.stringify(this.props.data, null, 2));
    ...
    console.log('🎯 [SavingsTab] handleMultiSelect: multipleChoice =', multipleChoice);
    console.log('🎯 [SavingsTab] handleMultiSelect: this.props.data.multiple_choice RAW VALUE =', this.props.data.multiple_choice);
    ...
    if (multipleChoice) {
      ...
      console.log('🎯 [SavingsTab] handleMultiSelect: single-select, newValues =', newValues);
    }
  ...
  renderOptions = () => {
    ...
    console.log('🎯 [SavingsTab] renderOptions - multiple_choice =', this.props.data.multiple_choice);
    console.log('🎯 [SavingsTab] renderOptions - multipleChoice (computed) =', multipleChoice);
    console.log('🎯 [SavingsTab] renderOptions - sectionSubtitle =', sectionSubtitle);
    
    return (
      <View style={styles.section}>
        <Text style={styles.sectionTitle}>{this.props.data.description || 'Savings'}</Text>
